...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        self.app.post('/create_author', data=author_data)
        # Verify that the author was updated in the database

        # get created author
        created_author = Author.query.filter_by(name='somename').first()
        # make sure that the created author exists
        self.assertIsNotNone(created_author)
        # make sure that the created author is the same author by testing the author's name
        self.assertEqual(created_author.name, 'somename')
    ...
    def test_create_genre(self):
        ...
        self.app.post('/create_genre', data=genre_data)
        # Verify that the genre was updated in the database
        created_genre = Genre.query.filter_by(name='somegenre').one()
        self.assertIsNotNone(created_genre)
        self.assertEqual(created_genre.name, 'somegenre')
    ...
    def test_favorite_book(self):
        ...
        self.app.post('/favorite/1', data=favorited_post)
        book = Book.query.get(1)
        ...
        self.assertEqual(favorited_book, user.favorite_books[0])
    ...
    def test_unfavorite_book(self):
        ...
        self.app.post('/favorite/1', data=favorited_post)
        self.app.post('/unfavorite/1', data=favorited_post)
